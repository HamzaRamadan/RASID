...
//     return (
//       <div className="w-full flex justify-start px-8 mb-6">
//         <div className="w-[400px]">
//           <div className="rounded-3xl p-4 shadow-md flex flex-col justify-between cursor-pointer bg-[#33F3FF52] border-2 border-white transition-all duration-200">
...
//                   <div className="text-2xl font-bold">{data.main}</div>
//                   <p className="text-[18px]">{data.sub}</p>
//                 </div>
//                 <img src={data.imgCard} className="w-10 h-10 -mt-2" />
//               </div>

//               <div className="flex-1 flex items-center gap-2 -ml-20">
//                 <div className="flex flex-col">
//                   <div className="text-2xl font-bold">{data.forecastMain}</div>
//                   <p className="text-[18px]">{data.forecast}</p>
//                 </div>
//                 <img src={data.imgCard} className="w-10 h-10 -mt-2 -ml-1" />
//               </div>
//             </div>
...
//                   className="w-6 h-6"
//                 />
//                 <div className="text-[16px]">{data.change}</div>
//               </div>
